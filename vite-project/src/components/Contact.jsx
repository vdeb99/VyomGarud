...
import contact from "../../medias/contact.webp";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          <div className="text-center lg:text-left">
            <h3 className="text-3xl font-semibold text-gray-200 mb-6 leading-snug">
              ...
              UAV solution overview, timelines, and engagement model.
            </h3>

            <p className="text-gray-400 text-lg leading-relaxed">
              Whether you're exploring reconnaissance UAVs, tactical drones,
              custom payload integrations, or enterprise deployment — we provide
              detailed technical insights, mission planning, and next-step
              recommendations.
            </p>
          </div>
