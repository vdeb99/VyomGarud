...
export default function Products() {
  ...
  return (
    <section id="products" className="py-16 sm:py-20 px-10 sm:px-6 lg:px-8 relative bg-gradient-to-br from-orange-800/20 to-gray-300/20">
  ...
  {activeCard !== null && (
    ...
    >
      ...
      <motion.img
        ...
        className="w-full h-150 object-cover rounded-xl shadow-xl mb-6"
      />
